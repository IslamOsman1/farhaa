    ...
    <section id="templates" className="section templates-section" ref={sectionRef}>
      ...
      <div className="templates-grid">
        {templates.map((tpl, index) => (
          <a href={`/${tpl.id}/index.html`} target="_blank" rel="noopener noreferrer" key={tpl.id} className="template-card reveal" style={{ transitionDelay: `${index * 0.2}s`, display: 'block', textDecoration: 'none', color: 'inherit' }}>
